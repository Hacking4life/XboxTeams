...
public async	componentWillMount() {
        ...
        var context = this;
        axios.all([this.getUserProfile(token)]).then(axios.spread(function (acct) {
			let data = {
				success: true,
				leaders: [
					{ id: 1, name: 'L LAWLIET3726', score: 12495 },
			...
			Gamerpic: String(acct.data.profileUsers[0].settings[4].value).toLocaleLowerCase().indexOf('https') > 0?acct.data.profileUsers[0].settings[4].value:"https://cdn.dribbble.com/users/924650/screenshots/6606195/robohobo_detailed.png",
			leaders: data.leaders,
					maxScore: data.maxScore,
					dataloaded:true
				});
