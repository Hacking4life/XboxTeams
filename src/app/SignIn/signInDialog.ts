...
import { ComponentDialog,ChoicePrompt, DialogSet, DialogTurnStatus, OAuthPrompt, TextPrompt, WaterfallDialog } from 'botbuilder-dialogs'
import { OAuthHelpers } from "../scripts/Utilities/oAuthHelpers"
import { LogoutDialog } from "../SignIn/logoutDialog"
        ...
        if (step.result) {
            ...
            if (tokenResponse && tokenResponse.token) {
                ...
                case 'me':
                    ...
                    break;
                case 'invite':
                    await OAuthHelpers.sendMail(step.context, tokenResponse);
                    break;
                default:
